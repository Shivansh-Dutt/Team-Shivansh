  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 to-green-400 min-h-screen flex flex-col">
      ...
      <nav className="flex justify-between items-center px-8 py-4 bg-white shadow-md">
        <h1 className="text-2xl font-bold text-gray-800">Community Needs Map</h1>
        <div className="space-x-4">
          <Link to="/login" className="px-4 py-2 text-blue-700 border border-blue-700 rounded hover:bg-blue-700 hover:text-white">
            Login
          </Link>
          <Link to="/signup" className="px-4 py-2 bg-blue-700 text-white rounded hover:bg-blue-800">
            Signup
          </Link>
        </div>
      </nav>
      ...
      <header className="flex flex-col lg:flex-row items-center justify-center flex-1 text-center lg:text-left px-8 lg:px-20 py-12">
        <div className="lg:w-1/2">
          ...
          <p className="text-lg text-gray-100 mb-6">
            Join a network of individuals and volunteers committed to solving community problems. Report needs, offer help, and make a difference!
          </p>
          <div className="flex justify-center lg:justify-start gap-4">
            <Link to="/signup" className="px-6 py-3 bg-white text-blue-700 font-bold rounded shadow-md hover:bg-gray-100">
              Get Started
            </Link>
            <a href="#features" className="px-6 py-3 border-2 border-white text-white font-bold rounded hover:bg-white hover:text-blue-700">
              Learn More
            </a>
          </div>
        </div>
